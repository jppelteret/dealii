...
int main(int argc, char *argv[])
{
  ...
  // TrilinosWrappers::SparseMatrix
  {
    ...
    // {
    //   // TODO: error: no member named 'get_mpi_communicator' in 'dealii::TrilinosWrappers::SolverDirect'
    //   // TODO: error: no member named 'locally_owned_domain_indices' in 'dealii::TrilinosWrappers::SolverDirect'
    //   // TODO: error: no member named 'locally_owned_range_indices' in 'dealii::TrilinosWrappers::SolverDirect'
    //   // TODO: error: no member named 'trilinos_matrix' in 'dealii::TrilinosWrappers::SolverDirect'
    //   // TODO: error: no member named 'transpose' in 'dealii::TrilinosWrappers::SolverDirect'
    //   // TODO: error: no member named 'vmult' in 'dealii::TrilinosWrappers::SolverDirect'
    //   // TODO: error: no member named 'Tvmult' in 'dealii::TrilinosWrappers::SolverDirect'
    //
