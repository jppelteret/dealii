...
run()
{
...

  {
    ...
    std::cout << "Scalar * Laplacian: " << ((f1 * laplacian).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "Scalar * Hessian: " << ((f1 * hessian).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "Scalar * third derivative: " << ((f1 * third_derivative).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
...

  {
    ...
    std::cout << "Vector * value: " << ((f1 * value).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "Vector * gradient: " << ((f1 * gradient).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "Vector * Laplacian: " << ((f1 * laplacian).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "Vector * Hessian: " << ((f1 * hessian).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "Vector * third derivative: " << ((f1 * third_derivative).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
...

  {
    ...
    std::cout << "Tensor * value: " << ((f1 * value).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "Tensor * gradient: " << ((f1 * gradient).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "Tensor * Laplacian: " << ((f1 * laplacian).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "Tensor * Hessian: " << ((f1 * hessian).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "Tensor * third derivative: " << ((f1 * third_derivative).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
...

  {
    ...
    std::cout << "SymmetricTensor * value: " << ((f1 * value).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "SymmetricTensor * gradient: " << ((f1 * gradient).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "SymmetricTensor * Laplacian: " << ((f1 * laplacian).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "SymmetricTensor * Hessian: " << ((f1 * hessian).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
    std::cout << "SymmetricTensor * third derivative: " << ((f1 * third_derivative).template operator()<NumberType> (fe_values,solution))[q_point] << std::endl;
