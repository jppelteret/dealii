...
main()
{
  ...
  // Not working?
  deallog
    << is_symbolic_integral<typename std::decay<decltype(blf_dV)>::type>::value
    << std::endl;
  deallog
    << is_symbolic_integral<typename std::decay<decltype(blf_dA)>::type>::value
    << std::endl;
  deallog
    << is_symbolic_integral<typename std::decay<decltype(blf_dI)>::type>::value
    << std::endl;

  deallog
    << is_symbolic_integral<typename std::decay<decltype(lf_dV)>::type>::value
    << std::endl;
  deallog
    << is_symbolic_integral<typename std::decay<decltype(lf_dA)>::type>::value
    << std::endl;
  deallog
    << is_symbolic_integral<typename std::decay<decltype(lf_dI)>::type>::value
    << std::endl;

  deallog << std::endl;

  deallog << is_symbolic_integral<
