...
//     {
//       template
//       TrilinosPayload::TrilinosPayload (const dealii::LinearOperator<VectorBase, VectorBase, TrilinosPayload> &inverse_op_exemplar,
//                                         const dealii::LinearOperator<VectorBase, VectorBase, TrilinosPayload> &inverse_op);
//
//       template
//       TrilinosPayload::TrilinosPayload (const dealii::LinearOperator<Vector, Vector, TrilinosPayload> &inverse_op_exemplar,
//                                         const dealii::LinearOperator<Vector, Vector, TrilinosPayload> &inverse_op);
//
//       template
//       TrilinosPayload::TrilinosPayload (const dealii::LinearOperator<MPI::Vector, MPI::Vector, TrilinosPayload> &inverse_op_exemplar,
//                                         const dealii::LinearOperator<MPI::Vector, MPI::Vector, TrilinosPayload> &inverse_op);
//     } /* namespace LinearOperator */
//   } /* namespace internal */
//
// #endif // DEAL_II_WITH_CXX11
