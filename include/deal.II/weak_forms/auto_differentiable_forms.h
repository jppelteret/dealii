...
namespace WeakForms
{
  namespace AutoDifferentiation
  {
    ...
    class EnergyFunctional
    {
      ...
      template <typename NumberType, typename... UnaryOpsSubSpaceFieldSolution>
      using functor_arguments_t =
        typename SelfLinearizationHelper_t<UnaryOpsSubSpaceFieldSolution...>::
    ...
    private:
      ...
      // std::vector<std::function<void()>> bilinear_form_integrand_minus_ops;
    };
