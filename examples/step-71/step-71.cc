...
namespace Step71
{
  ...
  namespace CoupledConstitutiveLaws
  {
    ...
    //         (red) of radius $r$ and height $H$ while an axially aligned magnetic field
    //         generated by a a magneto-rheological device. Although the time-dependent
    //         deformation profile of the may be varied, one common experiment would be to
    //         subject the material to a harmonic torsional deformation of constant amplitude
    //         and frequency $\omega$.
    //   </p>
    //     </td>
    //     <td align="center">
    ...
    //         azimuth $\Theta$ is displaced to location $\mathbf{p}$
