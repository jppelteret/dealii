...
#  endif // DOXYGEN
       ...
       * @param[in] cached_evaluation The vector that stores the numerical
       * values
       *            of all dependent variables referenced by the @p optimizer.
...
#  endif
       ...
       * stored in the @p cached_evaluation vector.
       */
      ReturnType
       ...
       * values stored in the @p cached_evaluation vector.
       */
      std::vector<ReturnType>
       ...
       * tensor components stored in the @p cached_evaluation vector.
       */
      template <int rank, int dim>
      SymmetricTensor<rank, dim, ReturnType>
