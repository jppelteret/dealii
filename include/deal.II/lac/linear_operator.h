...
inverse_operator(const LinearOperator<Range, Domain, Payload> &op,
                 ...
                 const Preconditioner &preconditioner)
{
//  static_assert(std::is_same<Range,typename Solver::vector_type>::value,
//                "Range vector type and solver vector type differ.");
//  static_assert(std::is_same<Domain,typename Solver::vector_type>::value,
