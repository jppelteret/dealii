...
// - Div-div matrix (symmetric tensor-valued finite element)
//
...
run()
{
  ...
  const FESystem<dim, spacedim>  fe(FE_Q<dim, spacedim>(1), SymmetricTensor<2,dim>::n_independent_components);
...

  {
    ...
    FEValuesExtractors::SymmetricTensor<2> field (0);
